...
public class svm_scale
{
	...
	public void run(String []argv, String scaledFilepath) throws IOException
	{
		int i,index;
        ...
        outputStream = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(scaledFilepath)));

        //outputStream = new DataOutputStream(new BufferedOutputStream(new FileOutputStream(save_filename)));
