...
public class svm {
	...
	public static byte[] svm_save_model1(String model_file_name, svm_model model) throws IOException
	{	
		
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		
		DataOutputStream fp = new DataOutputStream(new BufferedOutputStream(baos));
...
//		System.out.println(baos.toString());
	...
	public static void copy(FileInputStream input,
	...
	public static svm_model svm_load_model1(String myfile) throws FileNotFoundException, IOException 
	{//for testing
		ByteArrayOutputStream baos = new ByteArrayOutputStream();
		copy(new FileInputStream(myfile), baos,1024);
		byte[] bytes = baos.toByteArray();
		BufferedReader br = byteArray2Reader(bytes);
